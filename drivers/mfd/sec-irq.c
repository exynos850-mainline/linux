...
static const struct regmap_irq s2mpu12_irqs[] = {
        ...
        REGMAP_IRQ_REG(S2MPU12_IRQ_OI_B1, 4, S2MPU12_IRQ_OI_B1_MASK),
        REGMAP_IRQ_REG(S2MPU12_IRQ_OI_B2, 4, S2MPU12_IRQ_OI_B2_MASK),
        REGMAP_IRQ_REG(S2MPU12_IRQ_OI_B3, 4, S2MPU12_IRQ_OI_B3_MASK),
        REGMAP_IRQ_REG(S2MPU12_IRQ_OI_B4, 4, S2MPU12_IRQ_OI_B4_MASK),
        REGMAP_IRQ_REG(S2MPU12_IRQ_OI_B5, 4, S2MPU12_IRQ_OI_B5_MASK),
