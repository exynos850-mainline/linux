...
static const struct regmap_irq s2mpu12_irqs[] = {
        ...
        REGMAP_IRQ_REG(S2MPS14_IRQ_RTC60S, 1, S2MPU12_IRQ_RTC60S_MASK),
        REGMAP_IRQ_REG(S2MPS14_IRQ_RTCA1, 1, S2MPU12_IRQ_RTCA1_MASK),
        REGMAP_IRQ_REG(S2MPS14_IRQ_RTCA0, 1, S2MPU12_IRQ_RTCA0_MASK),
        REGMAP_IRQ_REG(S2MPS14_IRQ_SMPL, 1, S2MPU12_IRQ_SMPL_MASK),
        REGMAP_IRQ_REG(S2MPS14_IRQ_RTC1S, 1, S2MPU12_IRQ_RTC1S_MASK),
        REGMAP_IRQ_REG(S2MPS14_IRQ_WTSR, 1, S2MPU12_IRQ_WTSR_MASK),
        REGMAP_IRQ_REG(S2MPS14_IRQ_WTSRB, 1, S2MPU12_IRQ_WTSRB_MASK),
        ...
        REGMAP_IRQ_REG(S2MPU12_IRQ_OI_B1, 4, S2MPU12_IRQ_O1_B1_MASK),
