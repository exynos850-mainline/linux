...
#define S2MPU12_IRQ_PWRONF_MASK		(1 << 0)
#define S2MPU12_IRQ_PWRONR_MASK		(1 << 1)
#define S2MPU12_IRQ_JIGONBF_MASK	(1 << 2)
#define S2MPU12_IRQ_JIGONBR_MASK	(1 << 3)
#define S2MPU12_IRQ_ACOKBF_MASK		(1 << 4)
#define S2MPU12_IRQ_ACOKBR_MASK		(1 << 5)
#define S2MPU12_IRQ_PWRON1S_MASK	(1 << 6)
#define S2MPU12_IRQ_MRB_MASK		(1 << 7)

#define S2MPU12_IRQ_RTC60S_MASK		(1 << 0)
#define S2MPU12_IRQ_RTCA1_MASK		(1 << 1)
#define S2MPU12_IRQ_RTCA0_MASK		(1 << 2)
...
#define S2MPU12_IRQ_OCPB3_MASK		(1 << 2)
#define S2MPU12_IRQ_OCPB4_MASK		(1 << 3)
#define S2MPU12_IRQ_OCPB5_MASK		(1 << 4)
#define S2MPU12_IRQ_OCPBST_MASK		(1 << 5)

#define S2MPU12_IRQ_OI_B1_MASK		(1 << 0)
#define S2MPU12_IRQ_OI_B2_MASK		(1 << 1)
#define S2MPU12_IRQ_OI_B3_MASK		(1 << 2)
#define S2MPU12_IRQ_OI_B4_MASK		(1 << 3)
#define S2MPU12_IRQ_OI_B5_MASK		(1 << 4)

#define S2MPU12_IRQ_INT120C_MASK	(1 << 2)
#define S2MPU12_IRQ_INT140C_MASK	(1 << 3)
#define S2MPU12_IRQ_TSD_MASK		(1 << 4)
